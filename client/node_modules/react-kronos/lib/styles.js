...
function initializeMoment(options) {
  ...
  var lang = _moment3.default.locale();

  if (options && options.locale) {
    if (options.locale.lang) {
      lang = options.locale.lang;
      _moment3.default.locale(lang);
    }
    if (options.locale.settings) {
      _moment3.default.updateLocale(lang, options.locale.settings);
    }
  } else {
    _moment3.default.updateLocale(lang, {
      week: { dow: 1 },
...
function initializeOptions(options, instance) {
  _options[instance] = (0, _omit2.default)(options, 'moment');
}
...
function getStyle(page, props, instance) {
  ...
  var options = (0, _assign2.default)(defaultOptions, _options[instance]);
