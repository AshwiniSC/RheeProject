...
var Kronos = function (_Component) {
  ...
  function Kronos(props) {
    ...
    var _this = _possibleConstructorReturn(this, (Kronos.__proto__ || Object.getPrototypeOf(Kronos)).call(this, props));
  ...
  _createClass(Kronos, [{
    ...
    value: function render() {
      ...
      var mainClasses = (0, _classnames2.default)('react-kronos', this.props.instance, this.props.classes.kronos);
      var inputClasses = (0, _classnames2.default)(this.props.inputClassName, this.props.classes.input, { 'outside-range': this.state.dateTimeExceedsValidRange });
...
Kronos.propTypes = {
  ...
  shouldTriggerOnChangeForDateTimeOutsideRange: _propTypes2.default.bool,
  preventClickOnDateTimeOutsideRange: _propTypes2.default.bool,
  format: _propTypes2.default.string,
  onChangeDateTime: _propTypes2.default.func,
  returnAs: _propTypes2.default.oneOf([_constants.Types.ISO, _constants.Types.JS_DATE, _constants.Types.MOMENT, _constants.Types.STRING]),
  ...
  calendarStyle: _propTypes2.default.object,
  ...
  hideOutsideDateTimes: _propTypes2.default.bool,
  // Advanced controls
  controlVisibility: _propTypes2.default.bool,
...
Kronos.above = false;
exports.default = (0, _styledComponent2.default)(Kronos, function (props, instance) {
  return (0, _styles2.default)('index', props, instance);
});