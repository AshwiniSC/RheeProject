...
var Input = function (_Component) {
	...
	_createClass(Input, [{
		...
		value: function render() {
			...
			var input_props = _objectWithoutProperties(_props3, ['saveOnIcons', 'showCountrySelect', 'nativeExpanded', 'disabled', 'autoComplete', 'selectTabIndex', 'selectMaxItems', 'inputTabIndex', 'style', 'selectStyle', 'inputStyle', 'className', 'inputClassName', 'dictionary', 'countries', 'country', 'onCountryChange', 'flags', 'flagsPath', 'international', 'internationalIcon', 'convertToNational', 'metadata']);
	...
	this.on_change = function (value) {
		...
		if (value[0] === '+') {
			...
			if (value.length === 1) {
				...
				if (should_add_international_option(_this2.props)) {
				...
				else if (should_add_international_option(_this2.props) && country_code && value.indexOf(getPhoneCode(country_code) !== '+'.length)) {
						country_code = undefined;
						_this2.set_country_code_value(country_code);
					}
			}
...
function get_country_option_icon(country_code, _ref) {
